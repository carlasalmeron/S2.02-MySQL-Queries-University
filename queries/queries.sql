...
SELECT id, nombre, apellido1, apellido2, fecha_nacimiento FROM persona 
...
SELECT nombre, apellido1, apellido2, nif FROM persona 
...
SELECT id, nombre, cuatrimestre, curso, id_grado FROM asignatura 
...
SELECT 
	...
	curso_escolar.anyo_fin AS 'año de fin'
...
ORDER BY (departamento.nombre IS NULL) ASC, departamento.nombre ASC, persona.apellido1 ASC, persona.apellido2 ASC, persona.nombre ASC;
...
FROM departamento
LEFT JOIN profesor ON departamento.id = prpfesor.id_departamento
